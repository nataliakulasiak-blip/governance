...
window.UT_I18N.pl = {
  ...
  of_hero: 'Cztery drogi, cztery style podróży',
  pr_title: 'Jak pracujemy',
  pr_lead: 'Cztery kroki od pierwszej wiadomości do wyjazdu. Bez ukrytych opłat na żadnym etapie.',
  pr_1_t: 'Rozmowa',
  pr_1_d: 'Piszesz albo dzwonisz. Pytamy o termin, budżet, poziom języka i oczekiwania grupy.',
  pr_2_t: 'Propozycja',
  pr_2_d: 'W ciągu 24 godzin roboczych dostajesz dwie–trzy warianty z cenami i pełnym programem.',
  pr_3_t: 'Umowa',
  pr_3_d: 'Podpisujesz online. Dla szkół przygotowujemy komplet dokumentów dla dyrekcji i rodziców.',
  pr_4_t: 'Wyjazd',
  pr_4_d: 'Jedziesz. Zostajemy pod telefonem przez cały czas trwania wyjazdu.',
  err_title: 'Nie ma takiej strony',
  err_lead: 'Adres jest nieaktualny albo zawiera literówkę. Sprawdź, czy nie o to Ci chodziło:',
  err_cta: 'Wróć na stronę główną',
  priv: 'Polityka prywatności',
  terms: 'Regulamin',
  gal_title: 'Zdjęcia z naszych wyjazdów',
  gal_lead: 'Kadry zrobione przez nas i naszych podróżnych — bez stocków i bez retuszu.',
  gal_1: 'Sanktuarium w Fátimie — figura Matki Bożej w koronie',
  gal_2: 'Bazylika Matki Bożej Różańcowej w Fátimie',
  gal_3: 'Łodzie rybackie na portugalskim wybrzeżu o zachodzie słońca',
  gal_4: 'Arroz de marisco — portugalski ryż z owocami morza',
  pil_badge: 'Pielgrzymka',
  pil_title: 'Portugalia i Hiszpania — pielgrzymka',
  pil_lead: 'Czeka nas niezwykła podróż do miejsc, które od wieków przyciągają pielgrzymów z całego świata: Santiago de Compostela, Fátima, Lizbona i wiele innych. Będzie to czas modlitwy, refleksji, odkrywania pięknych miejsc i wspólnoty na drodze.',
  pil_dates_label: 'Termin',
  pil_dates: '9–17 października 2026',
  pil_route_label: 'Trasa',
  pil_route: 'Santiago de Compostela,Braga,Porto,Fátima,Cabo da Roca,Lizbona',
  pil_price_label: 'Cena',
  pil_price_note: 'od osoby',
  pil_inc_title: 'Cena zawiera',
  pil_includes: 'Przelot Warszawa–Porto i Lizbona–Warszawa z bagażem rejestrowym do 20 kg;7 noclegów w hotelach *** w pokojach 2- i 3-osobowych;7 śniadań i 7 kolacji;Transport klimatyzowanym autokarem na miejscu;Opieka pilota i usługi przewodnickie;Ubezpieczenie KL 30 000 EUR oraz NNW 15 000 zł;Opłaty wjazdowe do miast;Wstępy do zwiedzanych obiektów;Zwiedzanie w systemie TOURGUIDE;Obowiązkowa dopłata na Turystyczny Fundusz Gwarancyjny',
  pil_cta: 'Zapytaj o wolne miejsca',
  pil_more: 'Zobacz szczegóły wyjazdu',
  pil_price: '4 600 PLN + 140 EUR',
  pil_day: 'Dzień',
  pil_prog_title: 'Program dzień po dniu',
  pil_prog_note: 'Szczegółowy program publikujemy po polsku. Potrzebujesz go w innym języku? Napisz do nas.',
  rom_badge: 'Wycieczka samolotowa',
  rom_title: 'Roma Caput Mundi — Rzym, stolica świata',
  rom_lead: 'Rzym to miejsce, które trzeba zobaczyć przynajmniej raz w życiu. Od monumentalnego Koloseum i Forum Romanum, przez barokowe skarby Fontanny di Trevi, Piazza Navona i Schodów Hiszpańskich, po nowoczesny brutalizm — każdy zakątek kryje historię i niezapomniane widoki. Rzym to miasto, do którego się wraca. Zacznij swoją rzymską przygodę z nami!',
  rom_dates: 'Termin do ustalenia',
  rom_price: '350 PLN + 350 EUR',
  rom_route: 'Rzym,Watykan,Forum Romanum,Panteon,Fontanna di Trevi',
  rom_inc: 'Zakwaterowanie: 3 noclegi w hotelu MARIANO *** w centrum Rzymu i 3 śniadania;Transfery autokarem we Włoszech z lotniska i na lotnisko;Opieka doświadczonego pilota-przewodnika;VAT oraz obowiązkowa opłata na Turystyczny Fundusz Gwarancyjny;Ubezpieczenie NNW;Bilety wstępu: Bazylika św. Piotra, Santa Maria in Cosmedin z Ustami Prawdy, Bazylika Matki Bożej Większej;Bilety na komunikację miejską',
  rom_exc_title: 'Cena nie zawiera',
  rom_exc: 'Biletu lotniczego — od 300 PLN w obie strony z jednym małym bagażem podręcznym;Dopłaty do pokoju jednoosobowego — 100 EUR',
  rom_opt_title: 'Opcje dodatkowe',
  rom_opt: 'Koloseum, Palatyn i Forum Romanum — 20 EUR dorośli, 5 EUR dzieci i młodzież do 24 lat;Kolacja w rzymskim stylu z muzyką — cztery dania: przystawka, lasagne, pieczeń po rzymsku, tiramisu i wino bez ograniczeń — 40 EUR od osoby;Muzea Watykańskie — zwiedzanie z audioprzewodnikiem po polsku — 35 EUR',
  rom_notes_title: 'Dobrze wiedzieć',
  rom_notes: 'Zalecamy wykupienie ubezpieczenia od kosztów rezygnacji — koszt 3,5% ceny wycieczki;Kolejność punktów programu może ulec zmianie lub odwróceniu;Cena podstawowa obejmuje posiłki zgodnie z programem, ale nie obejmuje diet specjalnych i eliminacyjnych — bezglutenowej, bezlaktozowej czy wegańskiej;Uczestnicy muszą posiadać ważny dowód osobisty lub paszport',
  rgal_1: 'Pinie nad placem w centrum Rzymu',
  rgal_2: 'Wyspa Tyberyjska i most Fabrycjusza',
  rgal_3: 'Fiat 500 na Awentynie, przy ulicy Sant’Alessio',
  rgal_4: 'Łuk Konstantyna przy Koloseum',
  rgal_5: 'Forum Romanum w porannym słońcu',
  trips_eyebrow: 'Wyjazdy',
  trips_title: 'Najbliższe wyjazdy',
  trips_lead: 'Terminy potwierdzone i miejsca w sprzedaży. Po szczegóły wejdź w wybrany wyjazd albo po prostu zadzwoń.',
...
window.UT_I18N.en = {
  ...
  of_hero: 'Four routes, four styles of travel',
  pr_title: 'How we work',
  pr_lead: 'Four steps from your first message to departure. No hidden fees at any stage.',
  pr_1_t: 'Conversation',
  pr_1_d: 'You write or call. We ask about dates, budget, language level and what the group expects.',
  pr_2_t: 'Proposal',
  pr_2_d: 'Within 24 business hours you get two or three options with prices and the full programme.',
  pr_3_t: 'Contract',
  pr_3_d: 'You sign online. For schools we prepare the full document set for the head teacher and parents.',
  pr_4_t: 'Departure',
  pr_4_d: 'You travel. We stay reachable by phone for the whole trip.',
  err_title: 'Page not found',
  err_lead: 'The address is out of date or contains a typo. Perhaps you were looking for:',
  err_cta: 'Back to the homepage',
  priv: 'Privacy policy',
  terms: 'Terms and conditions',
  gal_title: 'Photos from our trips',
  gal_lead: 'Frames taken by us and by our travellers — no stock images, no retouching.',
  gal_1: 'The sanctuary at Fátima — the crowned statue of Our Lady',
  gal_2: 'The Basilica of Our Lady of the Rosary, Fátima',
  gal_3: 'Fishing boats on the Portuguese coast at sunset',
  gal_4: 'Arroz de marisco — Portuguese seafood rice',
  pil_badge: 'Pilgrimage',
  pil_title: 'Portugal and Spain — pilgrimage',
  pil_lead: 'An extraordinary journey awaits us to places that have drawn pilgrims from all over the world for centuries: Santiago de Compostela, Fátima, Lisbon and many more. It will be a time of prayer, reflection, discovery of beautiful places and companionship along the way.',
  pil_dates_label: 'Dates',
  pil_dates: '9–17 October 2026',
  pil_route_label: 'Route',
  pil_route: 'Santiago de Compostela,Braga,Porto,Fátima,Cabo da Roca,Lisbon',
  pil_price_label: 'Price',
  pil_price_note: 'per person',
  pil_inc_title: 'The price includes',
  pil_includes: 'Flights Warsaw–Porto and Lisbon–Warsaw with 20 kg checked baggage;7 nights in 3-star hotels in twin and triple rooms;7 breakfasts and 7 dinners;Air-conditioned coach throughout;Tour leader and guide services;Insurance: medical cover €30 000 and accident cover 15 000 PLN;City entry fees;Entrance tickets to every site visited;TOURGUIDE audio system;Mandatory Tourist Guarantee Fund contribution',
  pil_cta: 'Ask about availability',
  pil_more: 'See the trip details',
  pil_price: '4,600 PLN + €140',
  pil_day: 'Day',
  pil_prog_title: 'Day-by-day itinerary',
  pil_prog_note: 'The detailed itinerary is published in Polish. Need it in another language? Write to us.',
  rom_badge: 'Flight trip',
  rom_title: 'Roma Caput Mundi — Rome, capital of the world',
  rom_lead: 'Rome is a place to see at least once in a lifetime. From the mighty Colosseum and the Roman Forum, through the baroque treasures of the Trevi Fountain, Piazza Navona and the Spanish Steps, to modern brutalism — every corner hides history and unforgettable views. Rome is a city you come back to. Start your Roman adventure with us!',
  rom_dates: 'Dates to be agreed',
  rom_price: '350 PLN + €350',
  rom_route: 'Rome,Vatican,Roman Forum,Pantheon,Trevi Fountain',
  rom_inc: 'Accommodation: 3 nights at the 3-star Hotel Mariano in central Rome with 3 breakfasts;Coach transfers in Italy to and from the airport;An experienced tour leader and guide;VAT and the mandatory Tourist Guarantee Fund contribution;Accident insurance;Entrance tickets: St Peter’s Basilica, Santa Maria in Cosmedin with the Mouth of Truth, the Basilica of Saint Mary Major;Public transport tickets',
  rom_exc_title: 'The price does not include',
  rom_exc: 'Air ticket — from 300 PLN return with one small cabin bag;Single room supplement — €100',
  rom_opt_title: 'Optional extras',
  rom_opt: 'Colosseum, Palatine Hill and Roman Forum — €20 adults, €5 children and young people up to 24;Roman-style dinner with music — four courses: starter, lasagne, Roman roast, tiramisu and unlimited wine — €40 per person;Vatican Museums — guided visit with a Polish audio guide — €35',
  rom_notes_title: 'Good to know',
  rom_notes: 'We recommend taking out cancellation insurance — 3.5% of the tour price;The order of the programme may change or be reversed;The base price covers meals as scheduled but not special or elimination diets — gluten-free, lactose-free or vegan;Participants must hold a valid ID card or passport',
  rgal_1: 'Umbrella pines over a square in central Rome',
  rgal_2: 'Tiber Island and the Fabricius Bridge',
  rgal_3: 'A Fiat 500 on the Aventine, on Via di Sant’Alessio',
  rgal_4: 'The Arch of Constantine beside the Colosseum',
  rgal_5: 'The Roman Forum in the morning sun',
  trips_eyebrow: 'Trips',
  trips_title: 'Upcoming trips',
  trips_lead: 'Confirmed dates with places on sale. Open a trip for the details, or simply call us.',
...
window.UT_I18N.fr = {
  ...
  of_hero: 'Quatre itinéraires, quatre façons de voyager',
  pr_title: 'Comment nous travaillons',
  pr_lead: 'Quatre étapes entre votre premier message et le départ. Aucun frais caché.',
  pr_1_t: 'Échange',
  pr_1_d: 'Vous écrivez ou appelez. Nous demandons les dates, le budget, le niveau de langue et les attentes du groupe.',
  pr_2_t: 'Proposition',
  pr_2_d: 'Sous 24 heures ouvrées, vous recevez deux ou trois formules avec les tarifs et le programme complet.',
  pr_3_t: 'Contrat',
  pr_3_d: 'Signature en ligne. Pour les écoles, nous préparons le dossier complet pour la direction et les parents.',
  pr_4_t: 'Départ',
  pr_4_d: 'Vous partez. Nous restons joignables par téléphone pendant tout le séjour.',
  err_title: 'Page introuvable',
  err_lead: 'L’adresse est obsolète ou contient une faute. Vous cherchiez peut-être :',
  err_cta: 'Retour à l’accueil',
  priv: 'Politique de confidentialité',
  terms: 'Conditions générales',
  gal_title: 'Photos de nos voyages',
  gal_lead: 'Des images prises par nous et par nos voyageurs — sans banque d’images ni retouche.',
  gal_1: 'Le sanctuaire de Fátima — la statue couronnée de Notre-Dame',
  gal_2: 'La basilique Notre-Dame-du-Rosaire de Fátima',
  gal_3: 'Bateaux de pêche sur la côte portugaise au coucher du soleil',
  gal_4: 'Arroz de marisco — le riz portugais aux fruits de mer',
  pil_badge: 'Pèlerinage',
  pil_title: 'Portugal et Espagne — pèlerinage',
  pil_lead: 'Un voyage extraordinaire nous attend vers des lieux qui attirent depuis des siècles des pèlerins du monde entier : Saint-Jacques-de-Compostelle, Fátima, Lisbonne et bien d’autres. Ce sera un temps de prière, de réflexion, de découverte de lieux magnifiques et de partage tout au long du chemin.',
  pil_dates_label: 'Dates',
  pil_dates: '9–17 octobre 2026',
  pil_route_label: 'Itinéraire',
  pil_route: 'Saint-Jacques-de-Compostelle,Braga,Porto,Fátima,Cabo da Roca,Lisbonne',
  pil_price_label: 'Prix',
  pil_price_note: 'par personne',
  pil_inc_title: 'Le prix comprend',
  pil_includes: 'Vols Varsovie–Porto et Lisbonne–Varsovie avec bagage en soute de 20 kg;7 nuits en hôtels 3 étoiles en chambres doubles et triples;7 petits-déjeuners et 7 dîners;Autocar climatisé sur place;Accompagnateur et services de guide;Assurance frais médicaux 30 000 € et accident 15 000 PLN;Taxes d’entrée dans les villes;Billets d’entrée de tous les sites visités;Système audio TOURGUIDE;Contribution obligatoire au Fonds de garantie touristique',
  pil_cta: 'Demander les disponibilités',
  pil_more: 'Voir le détail du voyage',
  pil_price: '4 600 PLN + 140 €',
  pil_day: 'Jour',
  pil_prog_title: 'Programme jour par jour',
  pil_prog_note: 'Le programme détaillé est publié en polonais. Vous le voulez dans une autre langue ? Écrivez-nous.',
  rom_badge: 'Voyage en avion',
  rom_title: 'Roma Caput Mundi — Rome, capitale du monde',
  rom_lead: 'Rome est un lieu à voir au moins une fois dans sa vie. Du majestueux Colisée et du Forum romain aux trésors baroques de la fontaine de Trevi, de la place Navone et de la place d’Espagne, jusqu’au brutalisme moderne, chaque recoin cache une histoire et des panoramas inoubliables. Rome est une ville où l’on revient. Commencez votre aventure romaine avec nous !',
  rom_dates: 'Dates à convenir',
  rom_price: '350 PLN + 350 €',
  rom_route: 'Rome,Vatican,Forum romain,Panthéon,Fontaine de Trevi',
  rom_inc: 'Hébergement : 3 nuits à l’hôtel Mariano 3 étoiles dans le centre de Rome et 3 petits-déjeuners;Transferts en autocar en Italie depuis et vers l’aéroport;Accompagnement d’un guide-accompagnateur expérimenté;TVA et contribution obligatoire au Fonds de garantie touristique;Assurance accident;Billets d’entrée : basilique Saint-Pierre, Santa Maria in Cosmedin avec la Bouche de la Vérité, basilique Sainte-Marie-Majeure;Titres de transport en commun',
  rom_exc_title: 'Le prix ne comprend pas',
  rom_exc: 'Le billet d’avion — à partir de 300 PLN aller-retour avec un petit bagage à main;Le supplément chambre individuelle — 100 €',
  rom_opt_title: 'Options supplémentaires',
  rom_opt: 'Colisée, Palatin et Forum romain — 20 € adultes et 5 € enfants et jeunes jusqu’à 24 ans;Dîner à la romaine avec musique — quatre plats : entrée, lasagnes, rôti à la romaine, tiramisu et vin à volonté — 40 € par personne;Musées du Vatican — visite avec audioguide en polonais — 35 €',
  rom_notes_title: 'Bon à savoir',
  rom_notes: 'Nous recommandons de souscrire une assurance annulation — 3,5 % du prix du voyage;L’ordre du programme peut être modifié ou inversé;Le prix de base comprend les repas prévus mais pas les régimes spéciaux ou d’éviction — sans gluten, sans lactose ou végétalien;Les participants doivent être munis d’une carte d’identité ou d’un passeport en cours de validité',
  rgal_1: 'Des pins parasols au-dessus d’une place du centre de Rome',
  rgal_2: 'L’île Tibérine et le pont Fabricius',
  rgal_3: 'Une Fiat 500 sur l’Aventin, via di Sant’Alessio',
  rgal_4: 'L’arc de Constantin près du Colisée',
  rgal_5: 'Le Forum romain au soleil du matin',
  trips_eyebrow: 'Voyages',
  trips_title: 'Prochains départs',
  trips_lead: 'Dates confirmées et places en vente. Ouvrez un voyage pour le détail, ou appelez-nous.',
...
window.UT_I18N.es = {
  ...
  of_hero: 'Cuatro rutas, cuatro formas de viajar',
  pr_title: 'Cómo trabajamos',
  pr_lead: 'Cuatro pasos desde tu primer mensaje hasta la salida. Sin costes ocultos en ninguna fase.',
  pr_1_t: 'Conversación',
  pr_1_d: 'Escribes o llamas. Preguntamos fechas, presupuesto, nivel de idioma y qué espera el grupo.',
  pr_2_t: 'Propuesta',
  pr_2_d: 'En 24 horas laborables recibes dos o tres opciones con precios y el programa completo.',
  pr_3_t: 'Contrato',
  pr_3_d: 'Lo firmas en línea. Para centros escolares preparamos toda la documentación para dirección y familias.',
  pr_4_t: 'Salida',
  pr_4_d: 'Viajas. Seguimos localizables por teléfono durante todo el viaje.',
  err_title: 'Página no encontrada',
  err_lead: 'La dirección está obsoleta o tiene una errata. Quizá buscabas:',
  err_cta: 'Volver al inicio',
  priv: 'Política de privacidad',
  terms: 'Condiciones generales',
  gal_title: 'Fotos de nuestros viajes',
  gal_lead: 'Imágenes tomadas por nosotros y por nuestros viajeros: sin bancos de imágenes ni retoques.',
  gal_1: 'El santuario de Fátima: la imagen coronada de la Virgen',
  gal_2: 'La basílica de Nuestra Señora del Rosario de Fátima',
  gal_3: 'Barcas de pesca en la costa portuguesa al atardecer',
  gal_4: 'Arroz de marisco, el arroz portugués con marisco',
  pil_badge: 'Peregrinación',
  pil_title: 'Portugal y España — peregrinación',
  pil_lead: 'Nos espera un viaje extraordinario a lugares que desde hace siglos atraen a peregrinos de todo el mundo: Santiago de Compostela, Fátima, Lisboa y muchos más. Será un tiempo de oración, reflexión, descubrimiento de lugares maravillosos y convivencia en el camino.',
  pil_dates_label: 'Fechas',
  pil_dates: '9–17 de octubre de 2026',
  pil_route_label: 'Ruta',
  pil_route: 'Santiago de Compostela,Braga,Oporto,Fátima,Cabo da Roca,Lisboa',
  pil_price_label: 'Precio',
  pil_price_note: 'por persona',
  pil_inc_title: 'El precio incluye',
  pil_includes: 'Vuelos Varsovia–Oporto y Lisboa–Varsovia con equipaje facturado de 20 kg;7 noches en hoteles de 3 estrellas en habitaciones dobles y triples;7 desayunos y 7 cenas;Autocar con aire acondicionado durante todo el viaje;Acompañante de grupo y servicios de guía;Seguro de asistencia médica 30 000 € y accidentes 15 000 PLN;Tasas de entrada a las ciudades;Entradas a todos los lugares visitados;Sistema de audioguía TOURGUIDE;Aportación obligatoria al Fondo de Garantía Turística',
  pil_cta: 'Consultar plazas libres',
  pil_more: 'Ver los detalles del viaje',
  pil_price: '4.600 PLN + 140 €',
  pil_day: 'Día',
  pil_prog_title: 'Programa día a día',
  pil_prog_note: 'El programa detallado se publica en polaco. ¿Lo necesitas en otro idioma? Escríbenos.',
  rom_badge: 'Viaje en avión',
  rom_title: 'Roma Caput Mundi — Roma, capital del mundo',
  rom_lead: 'Roma es un lugar que hay que ver al menos una vez en la vida. Del imponente Coliseo y el Foro Romano a los tesoros barrocos de la Fontana di Trevi, la Piazza Navona y la Escalinata de la Plaza de España, hasta el brutalismo moderno: cada rincón esconde historia y vistas inolvidables. Roma es una ciudad a la que se vuelve. ¡Empieza tu aventura romana con nosotros!',
  rom_dates: 'Fechas por acordar',
  rom_price: '350 PLN + 350 €',
  rom_route: 'Roma,Vaticano,Foro Romano,Panteón,Fontana di Trevi',
  rom_inc: 'Alojamiento: 3 noches en el hotel Mariano de 3 estrellas en el centro de Roma y 3 desayunos;Traslados en autocar en Italia desde y hacia el aeropuerto;Acompañamiento de un guía-acompañante con experiencia;IVA y aportación obligatoria al Fondo de Garantía Turística;Seguro de accidentes;Entradas: basílica de San Pedro, Santa Maria in Cosmedin con la Boca de la Verdad y basílica de Santa María la Mayor;Billetes de transporte público',
  rom_exc_title: 'El precio no incluye',
  rom_exc: 'El billete de avión — desde 300 PLN ida y vuelta con un bulto de mano pequeño;El suplemento de habitación individual — 100 €',
  rom_opt_title: 'Opciones adicionales',
  rom_opt: 'Coliseo, Palatino y Foro Romano — 20 € adultos y 5 € niños y jóvenes hasta 24 años;Cena al estilo romano con música — cuatro platos: entrante, lasaña, asado a la romana, tiramisú y vino sin límite — 40 € por persona;Museos Vaticanos — visita con audioguía en polaco — 35 €',
  rom_notes_title: 'Conviene saber',
  rom_notes: 'Recomendamos contratar un seguro de cancelación — 3,5 % del precio del viaje;El orden del programa puede cambiar o invertirse;El precio base incluye las comidas previstas pero no dietas especiales o de eliminación — sin gluten, sin lactosa o veganas;Los participantes deben llevar un DNI o pasaporte en vigor',
  rgal_1: 'Pinos piñoneros sobre una plaza del centro de Roma',
  rgal_2: 'La isla Tiberina y el puente Fabricio',
  rgal_3: 'Un Fiat 500 en el Aventino, en la via di Sant’Alessio',
  rgal_4: 'El Arco de Constantino junto al Coliseo',
  rgal_5: 'El Foro Romano bajo el sol de la mañana',
  trips_eyebrow: 'Viajes',
  trips_title: 'Próximas salidas',
  trips_lead: 'Fechas confirmadas y plazas a la venta. Abre un viaje para ver el detalle o llámanos.',
...
window.UT_I18N.ru = {
  ...
  of_hero: 'Четыре маршрута, четыре стиля поездки',
  pr_title: 'Как мы работаем',
  pr_lead: 'Четыре шага от первого сообщения до выезда. Без скрытых платежей на любом этапе.',
  pr_1_t: 'Разговор',
  pr_1_d: 'Вы пишете или звоните. Мы уточняем даты, бюджет, уровень языка и ожидания группы.',
  pr_2_t: 'Предложение',
  pr_2_d: 'В течение 24 рабочих часов вы получаете два-три варианта с ценами и полной программой.',
  pr_3_t: 'Договор',
  pr_3_d: 'Подписываете онлайн. Для школ готовим полный пакет документов для дирекции и родителей.',
  pr_4_t: 'Поездка',
  pr_4_d: 'Вы едете. Мы остаёмся на связи по телефону всё время поездки.',
  err_title: 'Страница не найдена',
  err_lead: 'Адрес устарел или содержит опечатку. Возможно, вы искали:',
  err_cta: 'Вернуться на главную',
  priv: 'Политика конфиденциальности',
  terms: 'Правила',
  gal_title: 'Фотографии из наших поездок',
  gal_lead: 'Кадры, снятые нами и нашими путешественниками — без стоков и без ретуши.',
  gal_1: 'Святилище в Фатиме — статуя Богоматери в короне',
  gal_2: 'Базилика Богоматери Розария в Фатиме',
  gal_3: 'Рыбацкие лодки на португальском побережье на закате',
  gal_4: 'Arroz de marisco — португальский рис с морепродуктами',
  pil_badge: 'Паломничество',
  pil_title: 'Португалия и Испания — паломничество',
  pil_lead: 'Нас ждёт необыкновенное путешествие к местам, которые веками притягивают паломников со всего мира: Сантьяго-де-Компостела, Фатима, Лиссабон и многие другие. Это будет время молитвы, размышления, открытия прекрасных мест и общения в пути.',
  pil_dates_label: 'Даты',
  pil_dates: '9–17 октября 2026',
  pil_route_label: 'Маршрут',
  pil_route: 'Сантьяго-де-Компостела,Брага,Порту,Фатима,Кабо-да-Рока,Лиссабон',
  pil_price_label: 'Цена',
  pil_price_note: 'с человека',
  pil_inc_title: 'В цену входит',
  pil_includes: 'Перелёт Варшава–Порту и Лиссабон–Варшава с багажом до 20 кг;7 ночей в отелях 3* в двух- и трёхместных номерах;7 завтраков и 7 ужинов;Переезды на автобусе с кондиционером;Сопровождающий группы и услуги экскурсоводов;Страховка: медицинская 30 000 € и от несчастных случаев 15 000 злотых;Городские въездные сборы;Входные билеты во все посещаемые объекты;Аудиосистема TOURGUIDE;Обязательный взнос в Туристический гарантийный фонд',
  pil_cta: 'Узнать о свободных местах',
  pil_more: 'Подробности поездки',
  pil_price: '4 600 злотых + 140 €',
  pil_day: 'День',
  pil_prog_title: 'Программа по дням',
  pil_prog_note: 'Подробная программа публикуется на польском языке. Нужна на другом? Напишите нам.',
  rom_badge: 'Поездка с перелётом',
  rom_title: 'Roma Caput Mundi — Рим, столица мира',
  rom_lead: 'Рим — это место, которое нужно увидеть хотя бы раз в жизни. От величественного Колизея и Римского форума через барочные сокровища фонтана Треви, площади Навона и Испанской лестницы до современного брутализма — каждый уголок хранит историю и незабываемые виды. В Рим возвращаются. Начните своё римское приключение с нами!',
  rom_dates: 'Даты по согласованию',
  rom_price: '350 злотых + 350 €',
  rom_route: 'Рим,Ватикан,Римский форум,Пантеон,Фонтан Треви',
  rom_inc: 'Проживание: 3 ночи в отеле Mariano 3* в центре Рима и 3 завтрака;Трансферы на автобусе в Италии из аэропорта и в аэропорт;Сопровождение опытного гида-руководителя группы;НДС и обязательный взнос в Туристический гарантийный фонд;Страхование от несчастных случаев;Входные билеты: собор Святого Петра, Санта-Мария-ин-Космедин с Устами истины и базилика Санта-Мария-Маджоре;Билеты на городской транспорт',
  rom_exc_title: 'В цену не входит',
  rom_exc: 'Авиабилет — от 300 злотых туда и обратно с одной небольшой ручной кладью;Доплата за одноместный номер — 100 €',
  rom_opt_title: 'Дополнительные опции',
  rom_opt: 'Колизей, Палатин и Римский форум — 20 € взрослые и 5 € дети и молодёжь до 24 лет;Ужин в римском стиле с музыкой — четыре блюда: закуска, лазанья, римское жаркое, тирамису и вино без ограничений — 40 € с человека;Музеи Ватикана — посещение с аудиогидом на польском языке — 35 €',
  rom_notes_title: 'Полезно знать',
  rom_notes: 'Рекомендуем оформить страховку от отмены поездки — 3,5 % от стоимости тура;Порядок пунктов программы может измениться;Базовая цена включает питание по программе но не включает специальные и элиминационные диеты — безглютеновую безлактозную или веганскую;У участников должен быть действующий паспорт или удостоверение личности',
  rgal_1: 'Римские пинии над площадью в центре города',
  rgal_2: 'Тиберина и мост Фабричо',
  rgal_3: 'Fiat 500 на Авентине, на улице Сант-Алессио',
  rgal_4: 'Арка Константина рядом с Колизеем',
  rgal_5: 'Римский форум в утреннем солнце',
  trips_eyebrow: 'Поездки',
  trips_title: 'Ближайшие поездки',
  trips_lead: 'Подтверждённые даты и места в продаже. Откройте поездку или просто позвоните нам.',
...
window.UT_I18N.it = {
  ...
  of_hero: 'Quattro percorsi, quattro modi di viaggiare',
  pr_title: 'Come lavoriamo',
  pr_lead: 'Quattro passaggi dal primo messaggio alla partenza. Nessun costo nascosto in nessuna fase.',
  pr_1_t: 'Colloquio',
  pr_1_d: 'Ci scrivi o ci chiami. Chiediamo date, budget, livello di lingua e aspettative del gruppo.',
  pr_2_t: 'Proposta',
  pr_2_d: 'Entro 24 ore lavorative ricevi due o tre opzioni con prezzi e programma completo.',
  pr_3_t: 'Contratto',
  pr_3_d: 'Firmi online. Per le scuole prepariamo tutta la documentazione per dirigenza e famiglie.',
  pr_4_t: 'Partenza',
  pr_4_d: 'Parti. Restiamo raggiungibili al telefono per tutta la durata del viaggio.',
  err_title: 'Pagina non trovata',
  err_lead: 'L’indirizzo non è più valido o contiene un errore. Forse cercavi:',
  err_cta: 'Torna alla home',
  priv: 'Informativa sulla privacy',
  terms: 'Condizioni generali',
  gal_title: 'Foto dai nostri viaggi',
  gal_lead: 'Scatti fatti da noi e dai nostri viaggiatori — niente stock, niente ritocchi.',
  gal_1: 'Il santuario di Fátima — la statua incoronata della Madonna',
  gal_2: 'La basilica di Nostra Signora del Rosario a Fátima',
  gal_3: 'Barche da pesca sulla costa portoghese al tramonto',
  gal_4: 'Arroz de marisco — il riso portoghese ai frutti di mare',
  pil_badge: 'Pellegrinaggio',
  pil_title: 'Portogallo e Spagna — pellegrinaggio',
  pil_lead: 'Ci attende uno straordinario viaggio verso luoghi che da secoli attraggono pellegrini da tutto il mondo: Santiago de Compostela, Fátima, Lisbona e molti altri. Sarà un tempo di preghiera, riflessione, scoperta di luoghi meravigliosi e condivisione lungo il cammino.',
  pil_dates_label: 'Periodo',
  pil_dates: '9–17 ottobre 2026',
  pil_route_label: 'Itinerario',
  pil_route: 'Santiago de Compostela,Braga,Porto,Fátima,Cabo da Roca,Lisbona',
  pil_price_label: 'Prezzo',
  pil_price_note: 'a persona',
  pil_inc_title: 'Il prezzo comprende',
  pil_includes: 'Voli Varsavia–Porto e Lisbona–Varsavia con bagaglio in stiva da 20 kg;7 pernottamenti in hotel 3 stelle in camere doppie e triple;7 colazioni e 7 cene;Pullman con aria condizionata in loco;Accompagnatore e servizi di guida;Assicurazione spese mediche 30 000 € e infortuni 15 000 PLN;Tasse di ingresso nelle città;Biglietti d’ingresso a tutti i siti visitati;Sistema audio TOURGUIDE;Contributo obbligatorio al Fondo di Garanzia Turistica',
  pil_cta: 'Chiedi la disponibilità',
  pil_more: 'Vedi i dettagli del viaggio',
  pil_price: '4.600 PLN + 140 €',
  pil_day: 'Giorno',
  pil_prog_title: 'Programma giorno per giorno',
  pil_prog_note: 'Il programma dettagliato è pubblicato in polacco. Ti serve in un’altra lingua? Scrivici.',
  rom_badge: 'Viaggio in aereo',
  rom_title: 'Roma Caput Mundi — Roma, capitale del mondo',
  rom_lead: 'Roma è una meta da visitare almeno una volta nella vita. Dal maestoso Colosseo e dal Foro Romano, passando per i tesori barocchi della Fontana di Trevi, Piazza Navona e Piazza di Spagna, fino al brutalismo moderno, ogni angolo cela storia e panorami indimenticabili. Roma è un luogo in cui tornare. Inizia la tua avventura romana con noi!',
  rom_dates: 'Data da concordare',
  rom_price: '350 PLN + 350 €',
  rom_route: 'Roma,Vaticano,Foro Romano,Pantheon,Fontana di Trevi',
  rom_inc: 'Sistemazione: 3 notti presso l’hotel Mariano 3 stelle nel centro di Roma e 3 colazioni;Trasferimenti in pullman in Italia da e per l’aeroporto;Accompagnamento di una guida-accompagnatrice esperta;IVA e tassa obbligatoria per il Fondo di Garanzia Turistica;Assicurazione infortuni;Biglietti d’ingresso: Basilica di San Pietro, Santa Maria in Cosmedin con la Bocca della Verità, Basilica di Santa Maria Maggiore;Biglietti per il trasporto pubblico',
  rom_exc_title: 'Il prezzo non comprende',
  rom_exc: 'Il biglietto aereo — da 300 PLN andata e ritorno con un piccolo bagaglio a mano;Il supplemento camera singola — 100 €',
  rom_opt_title: 'Opzioni aggiuntive',
  rom_opt: 'Colosseo, Palatino e Foro Romano — 20 € adulti e 5 € bambini e ragazzi fino a 24 anni;Cena in stile romano con musica — quattro portate: antipasto, lasagne, arrosto alla romana, tiramisù e vino illimitato — 40 € a persona;Musei Vaticani — visita con audioguida in polacco — 35 €',
  rom_notes_title: 'Da sapere',
  rom_notes: 'Si consiglia di stipulare un’assicurazione di annullamento — 3,5% del prezzo del tour;L’ordine degli eventi del programma potrebbe subire variazioni o essere invertito;Il prezzo base include i pasti come previsto ma non comprende diete speciali o di eliminazione — senza glutine senza lattosio o vegane;I partecipanti devono essere in possesso di un documento d’identità o passaporto valido',
  rgal_1: 'Pini marittimi su una piazza del centro di Roma',
  rgal_2: 'L’Isola Tiberina e il ponte Fabricio',
  rgal_3: 'Una Fiat 500 sull’Aventino, in via di Sant’Alessio',
  rgal_4: 'L’Arco di Costantino accanto al Colosseo',
  rgal_5: 'Il Foro Romano nel sole del mattino',
  trips_eyebrow: 'Viaggi',
  trips_title: 'Prossime partenze',
  trips_lead: 'Date confermate e posti in vendita. Apri un viaggio per i dettagli, oppure chiamaci.',
...
(function () {
  ...
  function apply(lang) {
    ...
    Array.prototype.forEach.call(doc.querySelectorAll('[data-i18n-list]'), function (el) {
      var raw = t(el.getAttribute('data-i18n-list')) || '';
      // średnik ma pierwszeństwo, bo same pozycje mogą zawierać przecinki
      var items = raw.indexOf(';') > -1 ? raw.split(';') : raw.split(',');
